                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-8 mb-8">
                    <div className="space-y-4">        
                        <div className="mt-0">
                            ...
                            <div className="mt-6">
                                <h4 className="text-sm/6 font-semibold text-gray-700 mb-3 tracking-wide">Partnership</h4>
                                <a href="/" className="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-800 text-white rounded-lg">
                            ...
                            <div className="mt-8">
                                <div className="flex gap-3">
                                    <a href="/" className="w-9 h-9 flex items-center justify-center bg-gray-100 rounded-lg">
