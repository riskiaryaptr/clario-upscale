            ...
            <div className="bg-gray-100">
                <div className="mx-auto max-w-7xl px-4 py-4">
                    <p className="text-center text-[13px] text-gray-700 font-normal leading-normal tracking-wide">
                        ...
                        <a href="/" className="ml-2 font-semibold leading-normal tracking-wide text-blue-600 hover:text-blue-700">
                            Try it now →
                        </a>
                    </p>
                </div>
            ...
            <header className={`sticky top-0 z-50 border-b transition-all duration-300 ${ isScrolled ? 'bg-white/95 backdrop-blur-lg border-gray-200/50' : 'bg-white border-gray-200'}`}>
                <nav aria-label="Global" className="mx-auto max-w-7xl flex items-center justify-between p-5 xl:px-8">
                    ...
                    <div className="hidden xl:flex xl:gap-x-8 text-gray-700 font-medium leading-normal tracking-wide">
                        <a href="/" className={`text-sm/6 transition-colors ${isActive('/') || isActive('/index') ? 'text-blue-600' : 'hover:text-blue-600'}`}>Image Upscaler</a>                        
                            ...
                            {developersOpen && (
                                <div className="absolute left-1/2 -translate-x-1/2 top-full pt-4 w-[320px]">
                                    <div className="bg-white rounded-lg shadow-xl border border-gray-100 overflow-hidden animate-fadeIn">
                                        <div>
                                            <a href="/" className="flex items-start gap-5 px-4 py-3 hover:bg-gray-50 transition-colors hover:text-blue-600">
                                            ...
                                            <a href="/" className="flex items-start gap-5 px-4 py-3 hover:bg-gray-50 transition-colors">
                                                <div className="flex-shrink-0 mt-0.5">
                                                    <svg className="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="/Reimagine" className={`text-sm/6 transition-colors ${isActive('/Reimagine') ? 'text-blue-600' : 'hover:text-blue-600'}`}>Reimagine Upscaler</a>
                        <a href="/" className={`text-sm/6 transition-colors ${isActive('/crop') ? 'text-blue-600' : 'hover:text-blue-600'}`}>Crop Image</a>
                        <a href="/Pricing" className={`text-sm/6 transition-colors ${isActive('/Pricing') ? 'text-blue-600' : 'hover:text-blue-600'}`}>Princing</a>
                        <a href="/" className={`text-sm/6 transition-colors ${isActive('/blog') ? 'text-blue-600' : 'hover:text-blue-600'}`}>Blog</a>
                    </div>
                    ...
                    <div className="hidden xl:flex xl:flex-1 xl:justify-end xl:gap-x-4 xl:items-center">
                        ...
                        <a href="/" className="rounded-md bg-blue-600 px-3 py-2 text-[13px] font-semibold tracking-wide text-white shadow-sm">
                            Start Free Account
                        </a>
                    </div>
                </nav>
                        ...
                        <div className="px-6 mt-6 flow-root">
                            <div className="-my-6">
                                <div className="space-y-4 py-6 font-medium text-gray-700 text-sm/6">
                                    <a href="/" className="-mx-3 block rounded-lg px-3 py-2.5 border-b border-dotted border-gray-300">Image Upscaler</a>                                    
                                    <div className="border-b border-dotted border-gray-300">
                                        ...
                                        {mobileDevelopersOpen && (
                                            <div className="pb-3 pl-6 space-y-2 animate-fadeIn">
                                                <a href="/" className="block py-4 text-sm text-gray-600 hover:text-blue-600">
                                    ...
                                    <a href="/" className="-mx-3 block rounded-lg px-3 py-2.5 border-b border-dotted border-gray-300">Reimagine Upscaler</a>
                                    <a href="/" className="-mx-3 block rounded-lg px-3 py-2.5 border-b border-dotted border-gray-300">Crop Image</a>
                                    <a href="/" className="-mx-3 block rounded-lg px-3 py-2.5 border-b border-dotted border-gray-300">Pricing</a>
                                    <a href="/" className="-mx-3 block rounded-lg px-3 py-2.5 border-b border-dotted border-gray-300">Blog</a>
                                </div>

                                <div className="py-2 space-y-1">
                                    <a 
                                        href="/Login"
                                        className="-mx-3 block rounded-lg px-3 py-2.5 text-sm/6 font-semibold text-gray-700 hover:bg-gray-50"
                                    >
                                        Sign In
                                    </a>

                                    <a href="/" className="-mx-3 block rounded-md bg-blue-600 px-3 py-2.5 text-[13px] font-semibold tracking-wide text-white shadow-sm">
                                        Start Free Account
                                    </a>
                                </div>
                            </div>
